...
import { Check, ExternalLink, Lock, Shield, Zap } from "lucide-react";
    ...
    <div className="mx-auto w-full max-w-5xl space-y-16">
      ...
      <section className="text-center space-y-4">
        ...
        <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
          Tijori is built from the ground up with security as the primary concern. Your secrets are
          encrypted in your browser and never leave your device in plaintext.
        </p>
      </section>
      ...
      <section className="space-y-8">
        ...
        <p className="text-muted-foreground leading-relaxed">
          Tijori employs a <strong>zero-knowledge architecture</strong> where the server never sees
          plaintext secrets. All encryption and decryption happens client-side in the browser using
          the Web Crypto API. Even if our database were compromised, your secrets would remain
          encrypted and unusable without your passcodes.
        </p>
      </section>
...
└── Derive via PBKDF2 → Project CryptoKey
          ...
          <CardContent className="p-0 space-y-4">
            ...
            <div className="pt-4">
              <a
                ...
                rel="noreferrer"
              >
                <Button variant="outline" className="gap-2" title="Open security policy">
      ...
      <section className="text-center py-8">
        <Link to="/d/dashboard">
          <Button size="lg" className="gap-2" title="Go to dashboard">
            Go to Dashboard
          </Button>
        </Link>
      </section>
