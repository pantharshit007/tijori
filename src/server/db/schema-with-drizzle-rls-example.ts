...
// ============================================================================
// USERS TABLE - Example with Drizzle RLS Policies
// ============================================================================
/**
 * Users table to store profile information.
 * The `id` should match the Supabase Auth User ID.
 * 
 * NOTE: This demonstrates Drizzle's RLS policy support.
 * For complex policies, see supabase_rls_policies.sql
 */
export const usersWithDrizzleRLS = createTable(
  "user_example",
  (d) => ({
  ...
  (table) => [
    ...
    pgPolicy("users_delete_own_profile", {
      for: "delete",
      to: authenticatedRole,
      using: sql`${authUid} = ${table.id}`,
    }),
...
// ============================================================================
// ACTUAL SCHEMA (WITHOUT DRIZZLE RLS POLICIES)
// ============================================================================
// For production use, we keep the RLS policies in separate SQL files
// (supabase_rls_policies.sql) for better readability and flexibility.
// See DRIZZLE_RLS_INTEGRATION.md for more information.
// ============================================================================
